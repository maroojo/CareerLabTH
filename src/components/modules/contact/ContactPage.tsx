  ...
  return (
    <div className='mt-8'>
      <section className='w-full lg:w-1/2 flex flex-col justify-center items-center'>
        <h1 className='mt-5 capitalize text-5xl md:text-6xl lg:text-5xl font-bold font-grotesk max-w-screen-md text-center lg:text-start'>Contact</h1>
        <Image src={'asset/contact/contact.svg'} alt='operator' width={350} height={500} className='mt-10 lg:mt-16 h-auto w-3/4 md:w-5/12 lg:w-3/12' />
      </section>
      <section className='w-full lg:w-1/2 flex flex-col justify-center items-center mx-auto lg:mx-0'>
        <div className='mt-3 mb-3 w-full max-w-[300px] mx-auto'>
          <h3>For</h3>
